...
use machina_accel::ir::tb::{
    EXCP_EBREAK, EXCP_ECALL, EXCP_FENCE_I, EXCP_MRET,
...
impl Decode<Context> for RiscvDisasContext {
    ...
    fn trans_jal(
        ...
        let link = self.base.pc_next
            + self.cur_insn_len as u64;
    ...
    fn trans_fmadd_s(
        ...
        let rm =
            ir.new_const(Type::I64, a.rm as u64);
        let res = self.gen_helper_call(
            ir,
            (fpu::helper_fmadd_s as *const ())
                as usize,
...
impl Decode16<Context> for RiscvDisasContext {
    ...
    fn trans_addi(
        ...
        <Self as Decode<Context>>::trans_addi(
            self, ir, a,
        )
    }
    ...
    fn trans_lw(
        ...
        <Self as Decode<Context>>::trans_lw(
            self, ir, a,
        )
    }
    ...
    fn trans_ld(
        ...
        <Self as Decode<Context>>::trans_ld(
            self, ir, a,
        )
    }
    ...
    fn trans_c_fld(
        ...
        <Self as Decode<Context>>::trans_fld(
            self, ir, a,
        )
    }
    ...
    fn trans_c_flw(
        ...
        <Self as Decode<Context>>::trans_flw(
            self, ir, a,
        )
    }
    ...
    fn trans_sw(
        ...
        <Self as Decode<Context>>::trans_sw(
            self, ir, a,
        )
    }
    ...
    fn trans_sd(
        ...
        <Self as Decode<Context>>::trans_sd(
            self, ir, a,
        )
    }
    ...
    fn trans_c_fsd(
        ...
        <Self as Decode<Context>>::trans_fsd(
            self, ir, a,
        )
    }
    ...
    fn trans_c_fsw(
        ...
        <Self as Decode<Context>>::trans_fsw(
            self, ir, a,
        )
    }
    ...
    fn trans_lui(
        ...
        <Self as Decode<Context>>::trans_lui(
            self, ir, a,
        )
    }
    ...
    fn trans_srli(
        ...
        <Self as Decode<Context>>::trans_srli(
            self, ir, a,
        )
    }
    ...
    fn trans_srai(
        ...
        <Self as Decode<Context>>::trans_srai(
            self, ir, a,
        )
    }
    ...
    fn trans_andi(
        ...
        <Self as Decode<Context>>::trans_andi(
            self, ir, a,
        )
    }
    ...
    fn trans_sub(
        ...
        <Self as Decode<Context>>::trans_sub(
            self, ir, a,
        )
    }
    ...
    fn trans_xor(
        ...
        <Self as Decode<Context>>::trans_xor(
            self, ir, a,
        )
    }
    ...
    fn trans_or(
        ...
        <Self as Decode<Context>>::trans_or(
            self, ir, a,
        )
    }
    ...
    fn trans_and(
        ...
        <Self as Decode<Context>>::trans_and(
            self, ir, a,
        )
    }
    ...
    fn trans_jal(
        ...
        <Self as Decode<Context>>::trans_jal(
            self, ir, a,
        )
    }
    ...
    fn trans_beq(
        ...
        <Self as Decode<Context>>::trans_beq(
            self, ir, a,
        )
    }
    ...
    fn trans_bne(
        ...
        <Self as Decode<Context>>::trans_bne(
            self, ir, a,
        )
    }
    ...
    fn trans_addiw(
        ...
        <Self as Decode<Context>>::trans_addiw(
            self, ir, a,
        )
    }
    ...
    fn trans_subw(
        ...
        <Self as Decode<Context>>::trans_subw(
            self, ir, a,
        )
    }
    ...
    fn trans_addw(
        ...
        <Self as Decode<Context>>::trans_addw(
            self, ir, a,
        )
    }
    ...
    fn trans_slli(
        ...
        <Self as Decode<Context>>::trans_slli(
            self, ir, a,
        )
    }
    ...
    fn trans_jalr(
        ...
        <Self as Decode<Context>>::trans_jalr(
            self, ir, a,
        )
    }
    ...
    fn trans_ebreak(
        ...
        <Self as Decode<Context>>::trans_ebreak(
            self, ir, a,
        )
    }
    ...
    fn trans_add(
        ...
        <Self as Decode<Context>>::trans_add(
            self, ir, a,
        )
    }
}
